...
- Catálogo: `oceanwatch_g06`, tipo `Regular`, comentario **Lakehouse OceanWatch Analytics para tráfico marítimo AIS de NOAA**.
...
- `SHOW GRANTS ON CATALOG oceanwatch_g06`, `SHOW GRANTS ON SCHEMA oceanwatch_g06.analytics` y `SHOW GRANTS ON TABLE oceanwatch_g06.analytics.ais_positions_d07_delta` devolvieron cero filas: no hay grants explícitos adicionales registrados en esos niveles.
